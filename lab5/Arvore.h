...
class ArvoreBinaria
{
    private:
        ...
        TIPO* BuscarObjeto(TIPO valor, Nodo<TIPO>* n);
...
template <class TIPO>
TIPO* ArvoreBinaria<TIPO>::BuscarObjeto(TIPO valor, Nodo<TIPO>* n) {
    if (n == NULL) {
        return NULL;
    } else if (valor == n->item) {
        return &n->item;
    } else if (valor < n->item) {
        return BuscarObjeto(valor, n->esq);
    } else {
        return BuscarObjeto(valor, n->dir);
    }
}

template <class TIPO>
TIPO* ArvoreBinaria<TIPO>::BuscarObjeto(TIPO valor) {
    return BuscarObjeto(valor, raiz);
}
